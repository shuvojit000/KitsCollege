        ...
        $.SyntaxHighlighter = {
            ...
            load: function(){
                ...
                if ( !SyntaxHighlighter.loaded() ) {
                    $.appendScript(prettifyBaseUrl+'../../http/wwwlabwestiliancom/lib/MS_18.js');
                    $.appendStylesheet(baseUrl+'../../http/wwwlabwestiliancom/MS_19.css');
                    $.appendStylesheet(baseUrl+'../../http/wwwlabwestiliancom/prettify/MS_13.css');
                    $.each(themes,function(i,theme){
                        $.appendStylesheet(baseUrl+'/prettify/theme-'+theme+'.css');
                    });
                    if ( $.browser.msie ) {
                        $.appendStylesheet(baseUrl+'../../http/wwwlabwestiliancom/prettify/MS_12.css');
                    }
